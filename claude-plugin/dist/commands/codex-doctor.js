...
export async function collectCodexDoctorChecks() {
    const checks = [];
...
export function formatCodexDoctorReport(checks) {
    const failed = checks.filter(check => !check.ok).length;
    const lines = ['agent-awareness codex doctor', ''];
...
export async function codexDoctorReport() {
